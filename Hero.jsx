...
const ImageList = [
  {
    ...
    description:
      "Thomas Williams’ life is defined by resilience and passion, leaving a lasting impact on all who know his story.",
  },
  {
    id: 2,
    img: Book2,
...
const Hero = ({ handleOrderPopup }) => {
  ...
  const [description, setDescription] = React.useState(
    "Explore personalized recommendations, track your reading progress, and organize your library with ease on Bookly."
  );
